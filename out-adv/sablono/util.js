...
sablono.util.ToString = (function (){var obj24716 = {};
return obj24716;
})();
...
return (function (){var or__3772__auto__ = (sablono.util.to_str[(function (){var G__24720 = x__4416__auto__;
...
sablono.util.ToURI = (function (){var obj24722 = {};
return obj24722;
})();
...
var x__4416__auto__ = (((x == null))?null:x);
return (function (){var or__3772__auto__ = (sablono.util.to_uri[(function (){var G__24726 = x__4416__auto__;
return goog.typeOf(G__24726);
})()]);
if(or__3772__auto__){
return or__3772__auto__;
} else {
...
while (G__24727__i < G__24727__a.length) {G__24727__a[G__24727__i] = arguments[G__24727__i + 0]; ++G__24727__i;}
  xs = new cljs.core.IndexedSeq(G__24727__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__24728){
var xs = cljs.core.seq(arglist__24728);
...
var vec__24730 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24730,(0),null);
var words = cljs.core.nthnext(vec__24730,(1));
...
var G__24732 = clojure.set.rename_keys(m,kmap);
var G__24732__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$113.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__24732,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$113], null),camel_case_keys):G__24732);
return G__24732__$1;
} else {
return m;
}
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__24733_SHARP_){
if(cljs.core.list_QMARK_(p1__24733_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24733_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__24733_SHARP_)){
return p1__24733_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24733_SHARP_], null);
...
while (G__24734__i < G__24734__a.length) {G__24734__a[G__24734__i] = arguments[G__24734__i + 0]; ++G__24734__i;}
  maps = new cljs.core.IndexedSeq(G__24734__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__24735){
var maps = cljs.core.seq(arglist__24735);
...
var vec__24739 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$118,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24739,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24739,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__24739,tag_name,names){
return (function (p1__24736_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__24736_SHARP_));
});})(matches,vec__24739,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__24739,tag_name,names){
return (function (p1__24737_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__24737_SHARP_));
});})(matches,vec__24739,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__24740){
var vec__24743 = p__24740;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24743,(0),null);
var content = cljs.core.nthnext(vec__24743,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$118,tag,cljs.core.constant$keyword$106,content], null));
} else {
}

var vec__24744 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24744,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24744,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24744,(2),null);
